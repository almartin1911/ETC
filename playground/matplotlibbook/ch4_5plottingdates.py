...
# dates = []
# for i in range(10):
#     dates.append(dt.datetime.today() + dt.timedelta(days=i))
# LIST COMPREHENSIONS ARE SO FUCKING ELEGANT @_@
...
plt.show()
# %% Date formatting
date = dt.datetime(2009, 3, 28, 11, 34, 59, 12345)
date
import dateutil.parser
datestring = '2008-07-18 14:36:53.494013'
...
date2_1 = dt.datetime(2018, 9, 23)
date2_2 = dt.datetime(2018, 10, 3)
...
date1_1 = dt.datetime(2018, 9, 23)
date1_2 = dt.datetime(2019, 2, 16)
